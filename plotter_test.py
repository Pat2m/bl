...
def plot_skeleton(ax):
    ...
    for i in range(len(limbs)):
        ...
        s1,t1,b1 = drawCyl(limbs[i].start, limbs[i].orientation, limbs[i].length, .5)
...
def main():
    ...
    head = Limb("head")
    limbs = [  left_hand, left_forearm, left_bicep,
     right_hand, right_forearm, right_bicep,
    ...
    hostMACAddress = 'A4:B1:C1:33:DB:27'
    port = 3
    backlog = 1
    size = 1024
